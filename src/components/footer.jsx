  ...
  <footer className="bg-gray-900 text-white pt-12 pb-8 px-4">
    <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
        <a href="/" className="block mr-4 w-1/3">
            ...
            <h1>Never miss an update! Download our app for breaking news and more</h1>
        ...
        <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Headline</a></li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Bitcoin</a></li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Ether</a></li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Blockchain</a></li>
            </ul>
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Blogs</li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Learn</a>
                </li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">New blogs</a></li>
            </ul>
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">About us</li>
                <li><a href="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Contact us</a></li>
    ...
    <div className="pt-4 mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2025 WeTeach. All rights reserved.</div>
</footer>
  </>
