...
function MObileAppbanner() {
  return (
    <div    className="bg-gradient-to-b max-sm:hidden mx-auto max-sm:mt-2 mt-6 from-[#EEE40A] to-green-200 h-[124px] text-black font-semibold text-sm px-4 py-2 rounded-xl"
